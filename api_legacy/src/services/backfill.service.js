...
import { fetchHistoricalStockPrices, } from "./market-price.service.js";
import { fetchFundNav } from "./fund-nav.service.js";
export async function backfillMarketHistory(startDate, endDate) {
    ...
    for (const asset of assets) {
        ...
        try {
            ...
            if (asset.assetType === "fund") {
                const nav = await fetchFundNav(asset.symbol);
            ...
            // =========================
                ...
                const history = await fetchHistoricalStockPrices(asset, startDate, endDate);
